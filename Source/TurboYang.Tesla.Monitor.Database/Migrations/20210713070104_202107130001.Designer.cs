...
namespace TurboYang.Tesla.Monitor.Database.Migrations
{
    ...
    [Migration("20210713070104_202107130001")]
    partial class _202107130001
    {
...
#pragma warning disable 612, 618
            modelBuilder
                ...
                .HasPostgresEnum(null, "FirewareState", new[] { "Pending", "Updated" })
            ...
            modelBuilder.Entity("TurboYang.Tesla.Monitor.Database.Entities.AddressEntity", b =>
                {
                    ...
                    b.HasIndex("CreateTimestamp");

                    b.HasIndex("OpenId");

                    b.HasIndex("UpdateTimestamp");
            ...
            modelBuilder.Entity("TurboYang.Tesla.Monitor.Database.Entities.CarSettingEntity", b =>
                {
                    ...
                    b.Property<decimal?>("FullPower")
                        .HasColumnType("numeric")
                        .HasColumnName("FullPower");
            ...
            modelBuilder.Entity("TurboYang.Tesla.Monitor.Database.Entities.ChargingEntity", b =>
                {
                    ...
                    b.Property<decimal?>("EndBatteryRange")
                        .HasColumnType("numeric")
                        .HasColumnName("EndBatteryRange");
                    ...
                    b.Property<decimal?>("InsideTemperatureAverage")
                        .HasColumnType("numeric")
                        .HasColumnName("InsideTemperatureAverage");
                    ...
                    b.Property<decimal?>("OutsideTemperatureAverage")
                        .HasColumnType("numeric")
                        .HasColumnName("OutsideTemperatureAverage");

                    b.Property<decimal?>("StartBatteryLevel")
                        .HasColumnType("numeric")
                        .HasColumnName("StartBatteryLevel");

                    b.Property<decimal?>("StartBatteryRange")
                        .HasColumnType("numeric")
                        .HasColumnName("StartBatteryRange");
            ...
            modelBuilder.Entity("TurboYang.Tesla.Monitor.Database.Entities.ChargingSnapshotEntity", b =>
                {
                    ...
                    b.Property<decimal?>("BatteryRange")
                        .HasColumnType("numeric")
                        .HasColumnName("BatteryRange");
            ...
            modelBuilder.Entity("TurboYang.Tesla.Monitor.Database.Entities.FirewareEntity", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<FirewareState?>("State")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("\"FirewareState\"")
                    ...
                    b.HasIndex("CarId")
                        .HasDatabaseName("IX_Fireware_CarId");
            ...
            modelBuilder.Entity("TurboYang.Tesla.Monitor.Database.Entities.FirewareEntity", b =>
                {
                    b.HasOne("TurboYang.Tesla.Monitor.Database.Entities.CarEntity", "Car")
                        .WithMany()
                        .HasForeignKey("CarId")
                        .HasConstraintName("FK_Fireware_Car_CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
